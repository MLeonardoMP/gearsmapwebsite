      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-center">
          <div className="w-full px-4 lg:w-1/2">
            ...
            >
              <Image
                src="/images/about/agm2.jpg"
                alt="about image"
                fill
                className="drop-shadow-three dark:hidden dark:drop-shadow-none opacity-85 filter brightness-95 contrast-90"
              />
              <Image
                src="/images/about/agm2.jpg"
                alt="about image"
                fill
                className="drop-shadow-three hidden dark:block dark:drop-shadow-none opacity-85 filter brightness-95 contrast-90"
              />
            </div>
          </div>
          <div className="w-full px-4 lg:w-1/2">
